...
export const metadata: Metadata = {
  ...
  description: `Latest articles, tips, and guides from The Deep Mirror.`,
};
  ...
  return (
    <>
      ...
      <main className="flex-1 mx-auto max-w-3xl px-6 py-12">
        ...
        <p className="text-text-secondary mb-8">Latest articles and guides from The Deep Mirror.</p>
